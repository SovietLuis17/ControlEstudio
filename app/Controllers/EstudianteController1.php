...
// Ambos pueden asignar o quitar estudiantes de sus propias secciones
...
class EstudianteController
{
    ...
    // Muestra la vista principal con todos los estudiantes
    // Admin ve botones de editar y eliminar
    // Profesor ve editar pero no eliminar
    public function index(): void
    {
        $estudiantes = $this->model->obtenerTodos();
        $secciones = $this->modelSeccion->obtenerParaSelect();
        $rol = $_SESSION['rol'] ?? '';
