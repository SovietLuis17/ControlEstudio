...
// El estado "en_curso" se aplica cuando faltan notas por cargar
...
class NotaController
{
    ...
    // Aplica la regla: nota final solo con el 100% de actividades calificados
    public function ver(): void
    {
        ...
        // Calcular nota final ponderada y contar notas existentes
        $notaFinal = 0;
        $totalNotas = 0;
        ...
        // Determinar estado segun completitud y nota final
        if ($totalNotas === 0) {
            $estado = 'sin_notas';
            $notaFinal = null;
