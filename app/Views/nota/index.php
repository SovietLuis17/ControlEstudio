...
<body class="bg-light">
    ...
    <div class="container mt-4">
        ...
        <div class="mb-3">
            ...
            <span class="badge bg-secondary">En curso (notas incompletas)</span>
            <span class="badge bg-light text-dark border">Sin notas</span>
        </div>

        <!-- Aviso de coherencia sobre la nota final -->
        <div class="alert alert-light border">
            La nota final y el estado solo se muestran cuando el estudiante tiene
            calificacion en el 100% de las actividades del plan.
        </div>
                                ...
                                <?php foreach ($resumen as $fila): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ($fila['estado'] === 'sin_notas' || $fila['estado'] === 'en_curso'): ?>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php elseif ($fila['estado'] === 'en_curso'): ?>
